...
namespace LUC.DiscoveryServices.Kademlia.ClientPool
{
    sealed class ConnectionSettings
    {
        ...
        /// </summary>
        public Boolean ConnectionReset { get; }
        ...
        public Boolean DeferConnectionReset { get; }

        public Int32 CancellationTimeout { get; }
        public Int32 ConnectionTimeout { get; }
        public UInt32 Keepalive { get; }

        public Int32 MinimumPoolSize { get; }
        public Int32 MaximumPoolSize { get; }

        // Helper Functions
        Int32? m_connectionTimeoutMilliseconds;
        public Int32 ConnectionTimeoutMilliseconds
        {
            get
            {
