...
namespace Hardcodet.Wpf.TaskbarNotification.Interop
{
    ...
    public struct NOTIFYICONDATA
    {
        ...
        /// </summary>
        public BalloonIcons BalloonFlags;
        ...
        /// of the tray icon. If this member is non-NULL and the <see cref="BalloonIcons.User"/>
        ...
        public static NOTIFYICONDATA CreateDefault( IntPtr handle )
        {
            ...
            data.CallbackMessageId = WindowMessageSink.CALLBACK_MESSAGE_ID;
            data.VersionOrTimeout = (UInt32)NotifyIconVersion.Win95;
